...
tc qdisc add dev eth2 parent 10:1 handle 101: red limit 125000 min 37050 max 100000 probability 0.2 harddrop bandwidth 100mbit avpkt 1500
tc qdisc add dev eth2 parent 10:2 handle 102: red limit 200000 min 74500 max 200000 probability 0.2 harddrop bandwidth 100mbit avpkt 1500
