...
tc class add dev eth2 parent 10: classid 10:1 cdrr quantum 2250 tmax 1500 mode 1
tc class add dev eth2 parent 10: classid 10:2 cdrr quantum 1500 tmax 1500 mode 1

tc qdisc add dev eth2 parent 10:1 handle 101: bfifo_cc limit 100000 threshold 25000
tc qdisc add dev eth2 parent 10:2 handle 102: bfifo_cc limit 200000 threshold 90000
